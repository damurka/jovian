#ifndef ADRASTEA_HELPER_HPP
#define ADRASTEA_HELPER_HPP
...
namespace adrastea
{
    ADRASTEA_API std::string getStartMessage(const KernelConfiguration& config);
     ...
     */
    ADRASTEA_API std::string extractFilename(int &argc, char* argv[]);

    ADRASTEA_API bool shouldPrintVersion(int argc, char* argv[]);
